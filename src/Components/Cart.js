                  ...
                  {value.cart.map(cartData => {
                    return(
                      <div className="container-fluid text-center">
                        <div className="row">
                          <div className="col-10 max-auto col-lg-2">
                            <img style={{width: "6rem", height: "4rem"}} src={cartData.img}/>
                          </div>
                          <div className="col-10 max-auto col-lg-2">
                            {cartData.title}
                          </div>
                          ...
                          <div className="col-10 max-auto col-lg-2">
                            ...
                            {cartData.count}
                            <input size="sm" className="qtyminus" value="+" onClick={() => value.increment(cartData.id)}/>
                          </div>
                          <div className="col-10 max-auto col-lg-2">
                            <Button variant="secondary" onClick={() => {value.removeItem(cartData.id)}} size="sm">
                              Remove
                            </Button>
                          </div>
